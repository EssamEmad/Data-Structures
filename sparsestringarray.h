#ifndef __sparsestringarray__
#define __sparsestringarray__
#include "vector.h"
#include <stdbool.h> 
typedef struct {
  bool *bitmap; // set to be of size 'groupSize', takes a 0 if false a 1 if true
...
int getvectorindex(bool * bitmaps, int index);
#endif
